...
//drawLine() function is called to draw a line on the screen if condition is met.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y2 = coordY2,
        //This variable stores temporary x axis data that we update on our animation loop.
        x = x1,
        //this variable stores the temporary Y axis data that we update in our animation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        c.lineTo(x,y);
        //this method sets the widthof our line.
        c.lineWidth = 11;
        ...
        if (x1 <= x2 && y1 <= y2) {
            //thsi condition adds 10 to the previous end x endpoint;
            if (x < x2) { x += 10; }
    ...
    //This line disallowa clicking while the win sound is playing
    disableClick();
    //this line plays the win sounds.
    audio('./media/WinGame.mp3');
    //this line calls our main animation loop
    animateLineDrawing();
    //This line waits 1sec and then clears the canvas, resets game, and allows clicking again.
...
function resetGame() {
    ...
    //this reset our array so it is emptyand we can start over.
    selectedSquares = [];
}